                                        ...
                                        <table className="w-full text-left text-sm text-gray-400">
                                            <thead className="bg-black/40 text-xs uppercase font-mono text-gray-500 sticky top-0 backdrop-blur-sm">
                                                <tr>
                                                    ...
                                                    <th className="px-6 py-3 whitespace-nowrap">Tipo Assenza</th>
                                                    ...
                                                    return (
                                                        <tr key={l.id} className="hover:bg-white/5 transition group">
                                                            ...
                                                            <td className="px-6 py-4">
                                                                <span className="bg-slate-800 px-2 py-1 rounded border border-white/10 text-emerald-300">{l.leave_type}</span>
                                                            </td>
                                                            <td className="px-6 py-4 text-gray-400">
                                                                {l.requester?.full_name || '-'}
                                                            </td>
                                                            <td className="px-6 py-4 text-gray-500">
                                                                {format(parseISO(l.requested_at), "dd/MM/yy")}
                                                            </td>
                                                            ...
                                                            <td className="px-6 py-4">
                                                                <span className="flex items-center gap-1 text-emerald-500/80">
                                                                    ...
                                                                    {l.reviewer ? l.reviewer.full_name : 'Admin (Legacy)'}
                                                                </span>
                                                            </td>
                                                            <td className="px-6 py-4 text-right">
                                                                <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition">
                                                                    <button
                                                                        ...
                                                                        title="Modifica Note"
                                                                        onClick={() => alert("Modifica non ancora implementata. Simula eliminazione e ricreazione.")}
                                                                    >
                                                                        ✎
                                                                    </button>
                                                                    <button
