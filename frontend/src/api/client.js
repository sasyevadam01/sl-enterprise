...
export const logisticsApi = {
  ...
  takeRequest: (id, eta_minutes, mode = 'delivering') => client.patch(`/logistics/requests/${id}/take`, { promised_eta_minutes: eta_minutes, mode }),
  ...
  markPrepared: (id) => client.patch(`/logistics/requests/${id}/mark-prepared`),
