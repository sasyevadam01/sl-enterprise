...
DEFAULT_ROLES = [
    ...
    },
    {
        ...
        "is_static": False,
        "permissions": ["manage_shifts", "manage_tasks", "view_announcements", "request_events", "view_hr_calendar", "supervise_logistics", "view_dashboard", "request_logistics", "manage_logistics_pool", "block_vehicles", "view_charge_control"],
        "default_home": "/hr/tasks"
    },
    {
        "name": "record_user",
    ...
    },
    {
        ...
        "is_static": False,
        "permissions": ["view_dashboard", "view_announcements", "view_checklist_history", "manage_tasks", "perform_checklists", "access_factory", "manage_shifts", "block_vehicles", "view_charge_control"],
        "default_home": "/dashboard"
    },
]
