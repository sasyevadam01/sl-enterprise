...
def get_shift_label(shift):
    ...
    if shift == 'morning':
        return 'Check Mattutino (05:30 – 13:50)'
    elif shift == 'evening':
...
async def get_shift_info(
    ...
    try:
        ...
        if current_shift:
            ...
            if time_val < 330:
                msg = "Nessun check disponibile. Il turno mattutino inizia alle 05:30."
            elif 830 < time_val < 840:
                msg = "Pausa — il prossimo check sarà disponibile alle 14:00."
            else:
                msg = "Turno terminato. Il prossimo check sarà disponibile domani alle 05:30."
