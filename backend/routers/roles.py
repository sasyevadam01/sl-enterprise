...
async def get_permission_definitions(current_user: User = Depends(get_current_user)):
    ...
    return [
        ...
        {"code": "manage_production_config", "label": "Configurazione Produzione", "category": "Production", "description": "Gestione configurazioni blocchi e parametri di produzione."},
        {"code": "view_production_reports", "label": "Report Produzione", "category": "Production", "description": "Visualizzazione report e statistiche forniture blocchi."},
